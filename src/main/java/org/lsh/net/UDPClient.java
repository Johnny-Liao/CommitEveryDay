...
public class UDPClient {
    ...
    private static final int MAX_NUM = 5;      // 设置重发数据的最多次数
    ...
    public static void main(String args[]) throws IOException {
        ...
        if (receivedResponse) {
            ...
            // 如果重发MAX_NUM次数据后，仍未获得服务器发送回来的数据，则打印如下信息
